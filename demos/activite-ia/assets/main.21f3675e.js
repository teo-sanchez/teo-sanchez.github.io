var $e=Object.defineProperty;var oe=Object.getOwnPropertySymbols;var Be=Object.prototype.hasOwnProperty,Te=Object.prototype.propertyIsEnumerable;var le=(t,s,i)=>s in t?$e(t,s,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[s]=i,T=(t,s)=>{for(var i in s||(s={}))Be.call(s,i)&&le(t,i,s[i]);if(oe)for(var i of oe(s))Te.call(s,i)&&le(t,i,s[i]);return t};import{t as ue,f as ce,i as N,s as M,a as V,b as Ve,c as de,m as Ue,d as Oe,e as o,w as Ke,g,h as Fe,j as pe,k as me,l as Je,n as Ge,o as he,p as be,q as He,r as Qe,u as S,v as E,x as ge,y as We,z as ve,A as Ye,B as Ze,C as fe}from"./vendor.e33fb0e0.js";const Xe=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const p of r.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&n(p)}).observe(document,{childList:!0,subtree:!0});function i(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=i(a);fetch(a.href,r)}};Xe();const et={width:0,height:0,min:0,max:255,bw:!1};async function we(t={},s){const{width:i,height:n,min:a,max:r,bw:p}=T(T({},et),t),m=ue(()=>{let l=ce(s);if(i>0&&n>0)l=N.resizeBilinear(l,[i,n]);else if(i>0&&n===0){const b=s.height*i/s.width;l=N.resizeBilinear(l,[i,b])}else if(i===0&&n>0){const b=s.width*n/s.height;l=N.resizeBilinear(l,[b,n])}if(p){const b=M(.2989),_=M(.587),B=M(.114),k=V(l,[0,0,0],[l.shape[0],l.shape[1],1]),De=V(l,[0,0,1],[l.shape[0],l.shape[1],1]),Re=V(l,[0,0,2],[l.shape[0],l.shape[1],1]);l=Ve(de(de(k.mul(b),De.mul(_)),Re.mul(B)),[2])}return l=Ue(l,(r-a)/255),l=Oe(l,a),l}),h=await m.array();return m.dispose(),h}function tt(t={},s){return s!==void 0?we(t,s):i=>we(t,i)}const st={author:{name:"T\xE9o Sanchez"},dashboards:{title:"Apprentissage automatique"}},it={name:"Introduction",text:{title:"",content:"Voir dans le fichier index.js"},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},nt={name:"Histoire",text:{title:"",content:"Voir dans le fichier index.js"},timeline:"Chronologie de l'intelligence artificielle",video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},at={name:"Donn\xE9es",text:{title:"",content:"Voir dans le fichier index.js"},webcam:"Cam\xE9ra",input_files:"Charger des images",label:"Aposer une \xE9tiquette",button:"Enregistrer des images \xE9tiquet\xE9es de la cam\xE9ra",message_button:"Maintenir pour capturer",browser:{train:"Donn\xE9es d'entra\xEEnement",test:"Donn\xE9es de test"},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},rt={name:"Attributs",text:{title:"",content:"Voir dans le fichier index.js"},feature_title:"Les 1024 attributs calcul\xE9s par le r\xE9seau de neurone pr\xE9-entra\xEEn\xE9 MobileNetV1",title:"Extracteur d'attributs",video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},ot={name:"Entra\xEEnement",text:{title:"",content:"Voir dans le fichier index.js"},knn:{text:{title:"",content:"Voir dans le fichier index.js"},progress:"Progression de l'entra\xEEnement",params:"Param\xE8tres du classifieur kNN"},mlp:{text:{title:"",content:"Voir dans le fichier index.js"},progress:"Progression de l'entra\xEEnement",params:"Couches cach\xE9es du perceptron",plot:"Courbe d'apprentissage"},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},lt={name:"\xC9valuation",text:{title:"",content:"Voir dans le fichier index.js"},knn:{button:{title:"",content:"Mettre \xE0 jour les r\xE9sulats du kNN"},matrix:{train:"Matrice de corr\xE9lation du kNN sur l'ensemble d'entra\xEEnement",test:"Matrice de corr\xE9lation du kNN sur l'ensemble de test"}},mlp:{button:{title:"",content:"Mettre \xE0 jour les r\xE9sulats du MLP"},matrix:{train:"Matrice de corr\xE9lation du MLP sur l'ensemble d'entra\xEEnement",test:"Matrice de corr\xE9lation du MLP sur l'ensemble de test"}},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},ut={name:"D\xE9ploiement",text:{title:"",content:"Voir dans le fichier index.js"},display:"Image s\xE9lectionn\xE9e",toggle:{title:"Utiliser",content:"Activer"},mlp:{plot:"Pr\xE9dictions du MLP"},knn:{plot:"Pr\xE9dictions du kNN"},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},ct={name:"Attaque adversaire",text:{title:"",content:"Voir dans le fichier index.js"},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}},dt={name:"Cr\xE9dits",text:{title:"",content:"Voir dans le fichier index.js"}},pt={name:"Aider la recherche!",text:{title:"",content:"Voir dans le fichier index.js"},video:{url:"https://www.youtube.com/embed/JMS8WUEnxdQ",width:300,height:300,title:"Explications vid\xE9o"}};var e={misc:st,introduction:it,history:nt,data:at,embedding:rt,training:ot,evaluation:lt,deployment:ut,adversarial:ct,credits:dt,research:pt};const z=224;function v(t,s,i,n){return`<iframe src='${t}?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479' 
        width='${i}' height='${n}' 
        frameborder='0' allow='autoplay; fullscreen; picture-in-picture' allowfullscreen 
        title='${s}'></iframe>`}const mt=o(v(e.introduction.video.url,e.introduction.video.title,e.introduction.video.width,e.introduction.video.height));mt.title=e.introduction.video.title;const xe=o(`
...
Les questions associ\xE9es \xE0 cette activit\xE9 sont disponibles <a href="/demos/activite_ia/enonce_ia.pdf" target="_blank">\xE0 cette addresse</a>, ou sera distribu\xE9 par votre enseignant.
<BR>
<BR>
...
`);qe.title="";const ht=o(v(e.history.video.url,e.history.video.title,e.history.video.width,e.history.video.height));ht.title=e.history.video.title;const ye=o(`
<style>
.depliable img {
    display: none;
}
...
`);Le.title=e.history.timeline;const bt=o(v(e.data.video.url,e.data.video.title,e.data.video.width,e.data.video.height));bt.title=e.data.video.title;const Pe=o(`
<style>
.depliable img {
    display: none;
}
...
`);Pe.title=e.data.text.title;const P=Ke();P.title=e.data.webcam;const U=g("miniMASK");U.title="Donn\xE9es de ports de masques chirurgicaux";const O=g("miniROAD");O.title="Donn\xE9es de circulation routi\xE8re";const j=g("miniRETINA");j.title="Donn\xE9es m\xE9dicales de r\xE9tinographie";const K=g("miniTRASH");K.title="Donn\xE9es de d\xE9chets \xE0 trier";const _e=g("miniFRUIT");_e.title="Donn\xE9es de pommes et bananes";const f=Fe("localStorage"),u=pe("training-set-mlp-vs-knn",f),d=pe("test-set-mlp-vs-knn",f),x=me(u);x.title=e.data.browser.train;const q=me(d);q.title=e.data.browser.test;const gt=o(v(e.embedding.video.url,e.embedding.video.title,e.embedding.video.width,e.embedding.video.height));gt.title=e.embedding.video.title;const Ne=o(`
<style>
.depliable img {
    display: none;
}
...
`);Ne.title=e.embedding.text.title;const C=Je();C.title=e.embedding.title;const F=o("En attente de la s\xE9lection d'une image...<br><br><br><br><br><br><br><br><br><br>");F.title=e.embedding.feature_title;const vt=x.$selected.filter(t=>t.length===1).map(([t])=>u.get(t)).awaitPromises(),ft=q.$selected.filter(t=>t.length===1).map(([t])=>d.get(t)).awaitPromises(),wt=vt.merge(ft);wt.subscribe(t=>{var i=t.x[0].map(function(n){return n=n.toFixed(2),n});F.$value.set('<p style="font-size:10px;">'.concat(i.join(", "),"</p>"))});async function xt(t){const s=new Image;return new Promise(i=>{s.addEventListener("load",async()=>{const n=ue(()=>{const m=Ze(ce(s),M(255));return[N.resizeBilinear(m,[z,z]),N.resizeBilinear(m,[80,80])]}),a=new ImageData(await fe(n[0]),z,z),r=document.createElement("canvas");await fe(n[1],r);const p=r.toDataURL("image/jpeg");n[0].dispose(),n[1].dispose(),i([a,p])}),s.src=t})}async function y(t,s,i,n,a,r){s=="train"?await u.clear():await d.clear();const p=new Array(r.length);for(let h=0;h<r.length;h++)p[h]=Array.from(Array(i),(l,b)=>[`/assets/demos_data/${t}/${s}/${a[h]}_${s}_${b+1}.${n}`,`${r[h]}`]);let m=Promise.resolve();p.forEach(h=>{h.forEach(([l,b])=>{m=m.then(async()=>{const[_,B]=await xt(l),k={type:"image",image:_,y:b,thumbnail:B,x:await C.process(_),raw_features:await tt({width:3,height:3,max:1,bw:!0},_)};s=="train"?await u.create(k):await d.create(k)})})}),await m}U.$click.subscribe(async()=>{await y("miniMASK","train",10,"jpg",["masque-bien-mis","masque-mal-mis","pas-de-masque"],["Masque bien mis","Masque mal mis","Pas de masque"]),await y("miniMASK","test",10,"jpg",["masque-bien-mis","masque-mal-mis","pas-de-masque"],["Masque bien mis","Masque mal mis","Pas de masque"])});j.$click.subscribe(async()=>{await y("miniRETINA","train",10,"png",["sain","rd","dmla"],["Sain","R\xE9tinopathie Diab\xE9tique","DMLA"]),await y("miniRETINA","test",10,"png",["sain","rd","dmla"],["Sain","R\xE9tinopathie Diab\xE9tique","DMLA"])});K.$click.subscribe(async()=>{await y("miniTRASH","train",10,"jpg",["emballage","verre-blanc","verre-colore"],["Emballage","Verre blanc","Verre color\xE9"]),await y("miniTRASH","test",10,"jpg",["emballage","verre-blanc","verre-colore"],["Emballage","Verre blanc","Verre color\xE9"])});O.$click.subscribe(async()=>{await y("miniROAD","train",10,"jpg",["feu-orange","feu-rouge","feu-vert"],["Feu orange","Feu rouge","Feu vert"]),await y("miniROAD","test",10,"jpg",["feu-orange","feu-rouge","feu-vert"],["Feu orange","Feu rouge","Feu vert"])});const qt=o(v(e.training.video.url,e.training.video.title,e.training.video.width,e.training.video.height));qt.title=e.training.video.title;const A=g("Entra\xEEner le kNN");A.title="";const I=g("Entra\xEEner le MLP");I.title="";const ke=o(`
...
`);ke.title=e.training.text.title;const Me=o(`
<style>
.depliable img {
    display: none;
}
...
`);Me.title=e.training.knn.text.title;const Se=o(`
<style>
.center {
  display: block;
  margin-left: auto;
...
`);Se.title=e.training.mlp.text.title;const w=Ge({k:1,dataStore:f}).sync("mlp-vs-knn-knn"),J=he(w);J.title=e.training.knn.params;const G=be(w);G.title=e.training.knn.progress;const L=He({layers:[64],epochs:20,dataStore:f}).sync("mlp-vs-knn-mlp"),H=he(L);H.title=e.training.mlp.params;const Q=be(L);Q.title=e.training.mlp.progress;const W=Qe(L);W.title=e.training.mlp.plot;A.$click.subscribe(()=>{w.train(u,"raw_features")});I.$click.subscribe(()=>{L.train(u)});const yt=o(v(e.evaluation.video.url,e.evaluation.video.title,e.evaluation.video.width,e.evaluation.video.height));yt.title=e.evaluation.video.title;const Ee=o(`
...
`);Ee.title=e.evaluation.text.title;const Y=S({name:"MLP_train",dataset:u,dataStore:f}),Z=S({name:"KNN_train",dataset:u,dataStore:f}),X=S({name:"MLP_test",dataset:d,dataStore:f}),ee=S({name:"KNN_test",dataset:d,dataStore:f}),D=g(e.evaluation.knn.button.content);D.title=e.evaluation.knn.button.title;const R=g(e.evaluation.mlp.button.content);R.title=e.evaluation.mlp.button.title;const te=E(Y);te.title=e.evaluation.mlp.matrix.train;const se=E(Z);se.title=e.evaluation.knn.matrix.train;const ie=E(X);ie.title=e.evaluation.mlp.matrix.test;const ne=E(ee);ne.title=e.evaluation.knn.matrix.test;D.$click.subscribe(async()=>{w.ready||ge(new Error("Le classifieur kNN n'a pas \xE9t\xE9 entra\xEEn\xE9 sur les donn\xE9es d'entra\xEEnement")),await Z.clear(),await ee.clear(),await Z.predict(w,u),await ee.predict(w,d)});R.$click.subscribe(async()=>{w.ready||ge(new Error("Le classifieur MLP n'a pas \xE9t\xE9 entra\xEEn\xE9 sur les donn\xE9es d'entra\xEEnement")),await Y.clear(),await X.clear(),await Y.predict(L,u),await X.predict(L,d)});const Lt=o(v(e.deployment.video.url,e.deployment.video.title,e.deployment.video.width,e.deployment.video.height));Lt.title=e.deployment.video.title;const ze=o(`
...
<b>
`);ze.title=e.evaluation.text.title;const Pt=P.$images.filter(()=>P.$active.value).map(async t=>C.process(t)).awaitPromises(),_t=x.$selected.filter(t=>t.length===1).map(([t])=>u.get(t)).awaitPromises().map(t=>t.x),Nt=q.$selected.filter(t=>t.length===1).map(([t])=>d.get(t)).awaitPromises().map(t=>t.x),je=Nt.merge(_t).merge(Pt),kt=P.$images.filter(()=>P.$active.value),Mt=x.$selected.filter(t=>t.length===1).map(([t])=>u.get(t)).awaitPromises().map(t=>t.image),St=q.$selected.filter(t=>t.length===1).map(([t])=>d.get(t)).awaitPromises().map(t=>t.image);function Et(t){var s=new Uint8ClampedArray(t.width*t.height*4);for(let n=0;n<=3;n++)for(let a=0;a<t.width;a++)for(let r=0;r<t.height;r++)s[a*t.width*4+r*4+n]=t.data[a*t.width*4+(t.width-r)*4+n];var i=new ImageData(s,t.width,t.height);return i}const zt=kt.map(async t=>Et(t)).awaitPromises(),jt=zt.merge(Mt).merge(St),$=We(jt);$.title=e.deployment.display;const Ct=je.map(async t=>L.predict(t)).awaitPromises(),At=je.map(async t=>w.predict(t)).awaitPromises(),ae=ve(Ct);ae.title=e.deployment.mlp.plot;const re=ve(At);re.title=e.deployment.knn.plot;const It=o(v(e.adversarial.video.url,e.adversarial.video.title,e.adversarial.video.width,e.adversarial.video.height));It.title=e.adversarial.video.title;const Dt=o(`
Attaque adversaire, hacking ... `);Dt.title=e.adversarial.text.title;const Ce=o(`
...
`);Ce.title=e.credits.text.title;const Rt=o(v(e.research.video.url,e.research.video.title,e.research.video.width,e.research.video.height));Rt.title=e.research.video.title;const Ae=o(`
...
<br><br>
<b>Exercice:</b> R\xE9entra\xEEner les classieurs d'images sur d'autres donn\xE9es.`);Ie.title="";const c=Ye({title:e.misc.dashboards.title,author:e.misc.author.name});c.page(e.introduction.name).sidebar().use(xe,"Conseils",qe);c.page(e.history.name).sidebar().use("Consignes",ye,"Outils",Le);c.page(e.data.name).sidebar(U,O,j,K).use("Consignes",Pe,"Outils",[$,x,q]);c.page(e.embedding.name).sidebar(C).use("Consignes",Ne,"Outils",F,[x,q]);c.page(e.training.name).sidebar().use("Consignes",ke,"k plus proches voisins (kNN)",Me,[J,A,G],"Perceptron multicouche (MLP)",Se,[H,I,Q],W);c.page(e.evaluation.name).sidebar().use("Consignes",Ee,"Outils",[D,R],[se,te],[ne,ie]);c.page(e.deployment.name).sidebar(P).use("Consignes",ze,"Outils",[x,q],"Pr\xE9dictions",[$,re,ae]);c.page("Tout en un").sidebar(_e,j,P).use("Consignes",Ie,"Entra\xEEnement",[J,A,G],[H,I,Q],W,"\xC9valuation",[D,R],[se,te],[ne,ie],"D\xE9ploiement",[x,q],[$,re,ae]);c.page(e.research.name).sidebar().use(Ae);c.page(e.credits.name).use(Ce);c.settings.dataStores(f).datasets(u,d).models(w,L);c.show();
